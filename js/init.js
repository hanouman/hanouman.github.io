					...
					top.scroll(function(e) {
						...
						// If we found one ...
							...
							&&	!links.hasClass('scrollzer-locked'))
							{
								...
								$('.active-vinyl #supporter').removeClass().addClass('track-' + $('#' + lastId).attr('data-track'));
							}
					});
...
// Ready stuff
	...
	$(document).ready( function() {
		$('#nav a').click(function (e) {
			$('.active-vinyl #supporter').removeClass().addClass('track-' + $(e.currentTarget).attr('data-track'));
		});
	});
